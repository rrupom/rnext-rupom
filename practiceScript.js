        ...
        <div className="shadow-md rounded-lg bg-slate-800 border-slate-700">
            ...
            <div className="px-5 py-5">
                <div className="flex items-center justify-between mt-5">
                    ...
                    <span className="text-xl font-medium text-teal-500">Total: ৳ {quantity * productPrice}</span>
                </div>
                <div className="flex items-center justify-between mt-5">
                    <span className="text-2xl font-bold text-slate-300">৳ {productPrice}</span>
                    <a
                        href="#"
                        className="text-white focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-[#087ea4] hover:bg-[#087ea4]/[.8] focus:ring-[#087ea4]/[.5]" onClick={handleClick}
                    >Add to cart</a
                    >
                </div>
            </div>
